...
public class ModifyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		usernum = request.getParameter("usernum");//接收的工号
		//System.out.println("修改页面工号："+usernum);测试代码
		...
		java.sql.Date birthday_Date=Date.valueOf(birthday);//String转化为SQL date类型
		...
		try {
			...
			if(flag==false){//修改失败
				request.setAttribute("error", "modifyError");
			}
			else {//修改成功
				request.setAttribute("error", "noModifyError");
			}
